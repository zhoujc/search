...
function startLoading(){
   try{
            ctmap.mapview.showProgressDialog("加载中...");
      }catch (e){}
}
...
function endLoading(){
    try{
        ctmap.mapview.closeProgressDialog("");
    }catch (e){}
}
...
/*
* 获取访问服务器地址
* 正式环境：http://lbs.189.cn:18080
* 测试环境：http://116.228.55.124:58026
* */
function getBaseUrl(){

    var url = 'http://lbs.189.cn:18080';
    return url;
}
